 ...
 if(a==JOptionPane.YES_OPTION){
   ...
   reset();
     ...
     System.exit(0);
      ...
      g.setColor(Color.RED);
//The Points = The Snakes Are Moved By The Following Code.
...
public static void main(String args[]){
    ...
    jfm.getContentPane().setBackground(Color.WHITE);
     pl =new SnakePanel();
     lb.setBorder(BorderFactory.createTitledBorder(null, "Snake Game", TitledBorder.CENTER, TitledBorder.BELOW_TOP, new Font("Tahoma", 1, 24), new Color(204, 0, 0)));
